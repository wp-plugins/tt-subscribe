...
?>
    <div id="tt-subscribe-admin">
        ...
        <form method="post" action="options.php">
            ...
            <div><label for="tt-subscribe-color">Text Color</label></div>
            <input name="tt-subscribe-color" type="text" id="tt-subscribe-color" value="<?php echo get_option('tt-subscribe-color'); ?>" />
